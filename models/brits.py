...
class RITS(nn.Module):
    def __init__(self, seq_len, feature_num, rnn_hidden_size, configs):
...
class BRITS(nn.Module):
    def __init__(self, configs):
        ...
        # create models
        self.rits_f = RITS(configs.seq_len, configs.feature_num, configs.rnn_hidden_size, configs)
        self.rits_b = RITS(configs.seq_len, configs.feature_num, configs.rnn_hidden_size, configs)
